...
class TeamIcon(private val ownerInventory : InteractiveInventory, private val associatedTeam : Team, startingProgression: String){
    ...
    // so we don't constantly update the inventories events when its not needed
