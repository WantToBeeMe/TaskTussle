...
object ClickTaskManager : ITaskManager<ClickTask>(Material.BELL,"Click Task",
    ...
    override fun generateTasks(amounts: Triple<Int, Int, Int>, skip: Collection<ITask>): Array<ClickTask> {
       return Array(amounts.first + amounts.second + amounts.third) { ClickTask() }
    }
