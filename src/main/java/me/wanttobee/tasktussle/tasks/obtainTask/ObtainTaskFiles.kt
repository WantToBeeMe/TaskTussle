...
object ObtainTaskFiles {
    ...
    private val folder = File(TaskTussleSystem.TaskTussleBaseFolder, File.separator + "ObtainTask")
    ...
    fun generateDefaultFolder(): Boolean {
        ...
        if (inputStream == null) TaskTussleSystem.minecraftPlugin.logger.warning("'$defaultFile' not found in the resources folder.")
        else{
